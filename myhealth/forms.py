...
from myhealth.utils.validators import validate_email_format, validate_phone_number, validate_blood_pressure
...
class RegisterForm(forms.Form):
    ...
    email = forms.CharField(
        ...
        widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': 'Email'}))
    phone = forms.CharField(
        max_length=11, 
        validators=[validate_phone_number],
        widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': 'Phone number'}))
...
class HealthForm(forms.Form):
    ...
    blood_pressure = forms.CharField(
        ...
        widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': 'Blood Pressure (e.g. 120/80)'}))
    ...
    notes = forms.CharField(max_length=600, widget=forms.Textarea(attrs={'class': 'form-control mb-2', 'placeholder': 'Notes'}))